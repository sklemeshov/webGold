namespace payment.paypalwithdraw
{
    ...
    [DbObjectName("webrunes", "paypalwithdraw")]
    public class PayPalWithdrawEntity : CassandraEntity<PayPalWithdrawEntity>
    {
        ...
        internal const string RECEIVER_INFO_TYPE = "receiverInfoType";
        ...
        internal const string CORRELATION_ID = "correlationid";
        internal const string ERROR_TEXT = "errortext";
        ...
        [ColumnTicket(ACK, CassandraType.VARCHAR, true)]
        public string Ack
        {
            get
            {
                return this.GetData(ACK);
            }
            set
            {
                this.SetData(ACK, value);
            }
        }

        [ColumnTicket(CORRELATION_ID, CassandraType.VARCHAR, true)]
        public string CorrelationId
        {
            ...
            set
            {
                this.SetData(CORRELATION_ID, value);
            }
        }

        [ColumnTicket(ERROR_TEXT, CassandraType.VARCHAR, true)]
        public string ErrorText
        {
            get
            {
                return this.GetData(ERROR_TEXT);
            }
            set
            {
                this.SetData(ERROR_TEXT, value);
            }
        }
        ...
        [ColumnTicket(RECEIVER_INFO_TYPE, CassandraType.VARCHAR, true)]
        public string ReceiverInfoType
        {
            get
            {
                return this.GetData(RECEIVER_INFO_TYPE);
            }
            set
            {
                this.SetData(RECEIVER_INFO_TYPE, value);
            }
        }
